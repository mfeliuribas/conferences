...
* Explore how early Spanish-English bilinguals use the Spanish MF and the PF in general, as well as the PI and the PP for future reference, in natural speech
...
<b> Goal: </b> To examine the reported preference for the expression of futurity in Spanish and the locus of variation

* Participants (anticipated, N=100):
    * Min. 60 adult early Spanish-English bilinguals (i.e., Spanish heritage speakers) in the U.S.
...
* Procedure
    * Bilinguals complete the experiment in both Spanish and English (two weeks inbetween versions)
